...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
//4个网络模式
const u8 *ATK_ESP8266_CWMODE_TBL[3]={"STA Module ","AP Module ","AP&STA Module "};	//ATK-ESP8266,3种网络模式,默认为路由器(ROUTER)模式 
//4种工作模式
const u8 *ATK_ESP8266_WORKMODE_TBL[3]={"TCP Server","TCP Client"," UDP Module"};	//ATK-ESP8266,4种工作模式
//5种加密方式
...
void atk_8266_msg_show(u16 x,u16 y,u8 wanip)
{
	...
	//	Show_Str(x,y,240,16,"固件版本:",16,0);
	 LCD_ShowString(30,180,200,12,12,"固件版本:");	    
//		LCD_ShowString(x+72,y,240,16,p+12,16,");
	...
	//	Show_Str(x,y+32,240,16,"SSID号:",16,0);Show_Str(x+56,y+32,240,16,p+1,16,0);
		...
		p2=p1;
		*p1=0;		
		//Show_Str(x,y+48,240,16,"密码:",16,0);
	//	Show_Str(x+40,y+48,240,16,p+1,16,0);
		p=(u8*)strstr((const char*)(p2+1),",");
		p1=(u8*)strstr((const char*)(p+1),",");
		*p1=0;
//		Show_Str(x,y+64,240,16,"通道号:",16,0);
//		Show_Str(x+56,y+64,240,16,p+1,16,0);
//		Show_Str(x,y+80,240,16,"加密方式:",16,0);
//		Show_Str(x+72,y+80,240,16,(u8*)ATK_ESP8266_ECN_TBL[*(p1+1)-'0'],16,0);
	}
	myfree(SRAMIN,p);		//释放内存 
	myfree(SRAMIN,p1);		//释放内存 
	myfree(SRAMIN,p2);		//释放内存 
...
{ 
	POINT_COLOR=RED;
    LCD_ShowString(x,y,200,16,16,rmd);
	  LCD_ShowString(x,y+20,200,16,16,"SSID:");
	  LCD_ShowString(x,y+40,200,16,16,"PasswordWay:");
	  LCD_ShowString(x,y+60,200,16,16,"Password:");
...
//	Show_Str(x,y+52,240,12,"密码:",12,0); 
	POINT_COLOR=BLUE;
		LCD_ShowString(x+54,y+20,200,16,16,ssid);
	  LCD_ShowString(x+100,y+40,200,16,16,encryption);
	  LCD_ShowString(x+80,y+60,200,16,16,password);
...
//		LCD_ShowString(30,90,200,16,16,"ATOM@ALIENTEK");
 	//	LCD_ShowString(30,110,200,16,16,lcd_id);		//显示LCD ID
		...
		LCD_ShowString(x,y,210,24,16,p); 
	  LCD_ShowString(x,y+30,210,16,16,"KEY0:next"); 
		LCD_ShowString(x,y+60,210,16,16,"KEY1:previous"); 
		LCD_ShowString(x,y+90,210,16,16,"WK_UP:confirm"); 
		LCD_ShowString(x,y+120,210,16,16,"select,Please"); 
...
//	Show_Str(x,y+100,200,16,"请选择:",16,0); 
	POINT_COLOR=BLUE;
		LCD_ShowString(x+16,y+150,210,16,16,"TCP Server"); 
		LCD_ShowString(x+16,y+170,210,16,16,"TCP Client"); 
		LCD_ShowString(x+16,y+190,210,16,16,"UDP Model"); 
//	Show_Str(x+16,y+120,200,16,"TCP服务器",16,0); 				    	 
//	Show_Str(x+16,y+140,200,16,"TCP客户端",16,0);				    	 
//	Show_Str(x+16,y+160,200,16,"UDP模式",16,0); 
	POINT_COLOR=RED;
			LCD_ShowString(x,y+150,210,16,16,"+"); 
	...
	while(1)
	{
		...
		if(key)
		{
			...
			LCD_ShowString(x,y+150+netpro*20,210,16,16," "); //清空之前的显示
			...
			LCD_ShowString(x,y+150+netpro*20,210,16,16,"+"); //指向新条目
...
PRESTA:		
	...
	else if(netpro&0X10)     //AP TCP Client    透传模式测试
	{
		...
		LCD_ShowString(30,40,210,24,24,"ATK-ESP WIFI-STA 测试"); 
		LCD_ShowString(30,70,200,16,16,"正在配置ATK-ESP模块,请稍等...");
		...
		while(atk_8266_send_cmd(p,"OK",200))
			{
				LCD_Clear(WHITE);
				POINT_COLOR=RED;
				LCD_ShowString(30,130,200,12,12,"WK_UP:ComeBack");	
				LCD_ShowString(30,150,200,12,12,"ATK-ESP TCP Server Connection Fail");	 //连接失败	 
...
u8 atk_8266_ip_set(u8* title,u8* mode,u8* port,u8* ip) 
{
	...
	LCD_ShowString(30,120,200,12,16,title);	//显示标题
	LCD_ShowString(30,150,200,12,16,"Model:");	   	//工作模式显示
  LCD_ShowString(30,180,200,12,16,"IP:");	 	//IP地址可以键盘设置
  LCD_ShowString(30,210,200,12,16,"Port:");	  		//端口号
...
//	Show_Str(30,130,200,16,"端口:",16,0);	//端口号
	...
	POINT_COLOR=BLUE;
	LCD_ShowString(30+72,150,200,12,16,mode);	   	//显示工作模式	
	LCD_ShowString(30+40,210,200,12,16,port);	   		//显示端口 
 ...
 //	Show_Str(30+40,130,200,16,port,16,0);	//显示端口 	
	...
	{ 
		...
		{   
		 ...
		 LCD_ShowString(30+56,180,200,12,16,ip);	 	//显示IP地址 	
...
//	u16 rlen=0;
	...
	LCD_Clear(WHITE);
	POINT_COLOR=RED;
	LCD_ShowString(20,40,210,20,16,"ATK-ESP8266 WIFI TEST...");    
	while(atk_8266_send_cmd("AT","OK",20))//检查WIFI模块是否在线
	{
		atk_8266_quit_trans();//退出透传
		atk_8266_send_cmd("AT+CIPMODE=0","OK",200);  //关闭透传模式	
		LCD_ShowString(30,70,200,16,16,"No found!!!");
		delay_ms(800);
		LCD_Fill(40,55,200,55+16,WHITE);
		LCD_ShowString(30,90,200,16,16,"Trying connection...");
	} 
...
{ 
	LCD_Clear(WHITE);
	POINT_COLOR=RED;
  LCD_ShowString(30,120,200,12,16,"ATK_ESP8266 WIFI AP Model");	 	//显示IP地址 	
	LCD_ShowString(30,150,200,12,16,"Initializing...");	
  LCD_ShowString(30,180,200,12,16,"Waiting,please!");	
